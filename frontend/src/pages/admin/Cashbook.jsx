    ...
    try {
      ...
      if (exportModal === 'pdf') {
        ...
        try {
          ...
          doc.setFont('times', 'bold'); doc.setFontSize(16); doc.setTextColor(139, 26, 26)
          doc.text(SANSTHAN_NAME, margin + imgW * 0.052, imgY + imgH * 0.136 + 7, { maxWidth: imgW * 0.66 })
        ...
        if (headerImg) {
          html += `<div style="position:relative;margin:0 0 18px"><img src="${headerImg}" style="width:100%;display:block" /><div style="position:absolute;top:13.6%;left:5.2%;max-width:66%;font-family:'Cinzel','Segoe UI',serif;font-weight:700;font-size:16px;line-height:1.25;letter-spacing:0.2px;color:#8B1A1A">${SANSTHAN_NAME}</div></div><hr style="border:none;border-top:2px solid #8B1A1A;margin:0 0 18px" />`
        } else {
        ...
        const headerHtml = headerImg
          ? `<div style="position:relative;margin-bottom:18px"><img src="${headerImg}" style="width:100%;display:block" /><div style="position:absolute;top:13.6%;left:5.2%;max-width:66%;font-family:'Cinzel','Segoe UI',serif;font-weight:700;font-size:16px;line-height:1.25;letter-spacing:0.2px;color:#8B1A1A">${SANSTHAN_NAME}</div></div><hr style="border:none;border-top:2px solid #8B1A1A;margin:0 0 18px" />`
